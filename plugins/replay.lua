...
"موجوع كلبي😔والتعب بيه☹️من اباوع على روحي😢ينكسر كلبي عليه😭",
"ايامي وياها👫اتمنا انساها😔متندم اني حيل😞يم غيري هيه💃تضحك😂عليه😔مقهور انام الليل😢كاعد امسح بل رسائل✉️وجان اشوف كل رسايلها📩وبجيت هوايه😭شفت احبك😍واني من دونك اموت😱وشفت واحد 🚶صار هسه ويايه👬اني رايدها عمر عمر تعرفني كل زين🙈 وماردت لا مصلحه ولاغايه😕والله مافد يوم بايسها💋خاف تطلع🗣البوسه💋وتجيها حجايه😔️",
 "😔صوتي بعد مت سمعه✋يال رايح بلا رجعه🚶بزودك نزلت الدمعه ذاك اليوم☝️يال حبيتلك ثاني✌روح وياه وضل عاني😞يوم اسود عليه اني🌚 ذاك اليوم☝️تباها بروحك واضحك😂لان بجيتلي عيني😢😭 وافراح يابعد روحي😌خل الحركه تجويني😔🔥صوتي بعد متسمعه🗣✋",
...
send_msg(msg.to.id, 'يا ول شو طالعه عينك😒 من البنات مو😪و هم صايرلك لسان تحجي😠اشو تعال👋👊صير حباب مره ثانيه ترهه ...😉و لا تخليني البسك عمامه و اتفل عليك😂️',msg.reply_id, 'html')
end
...
elseif w== "تف" then
return  "عيب ابني/بتي اتفل/ي اكبر منها شويه 😌😹"
...
elseif w== "ضوجه"  then
return  "شي اكيد الكبل ماكو 😂 لو بعدك/ج مازاحف/ه 🙊😋"
elseif w== "اروح اصلي"  then
return  "انته حافظ سوره الفاتحه😍❤️️"
elseif w== "صاك"  then
...
elseif w=="شكو" then
return  "كلشي وكلاشي🐸تگـول عبالك احنـه بالشورجـه🌝"
elseif w=="انته منو" then
return  "آني كـامل مفيد اكبر زنگين أگعده عالحديـد🙌"
elseif w=="كلخرا" then
...
return  "لعرض قائمه المساعده اكتب الاوامر 🌚❤️"
elseif w== "زاحف"  then
...
elseif w== "واو"  then
return  "قميل 🌝🌿"
elseif w== "زاحفه" or w== "زاحفه"  then
...
elseif w== "المعزوفه" or w=="المعزوفه" or w=="معزوفه" then
return  "طرطاا طرطاا طرطاا 😂👌"
elseif w== "موجود"  then
return  "تفضل عزيزي 🌝🌸"
elseif w== "اكلك"  then
return  ".كول حياتي 😚🌿"
elseif w== "فدوه" or w=="فدوه" or w=="فطوه" or w=="فطوه" then      
return  "لكلبك/ج 😍❤️"
elseif w== "دي"  then
...
return "اللهم عذب المدرسين 😢 منهم الاحياء والاموات 😭🔥 اللهم عذب ام الانكليزي 😭💔 وكهربها بلتيار الرئيسي 😇 اللهم عذب ام الرياضيات وحولها الى غساله بطانيات 🙊 اللهم عذب ام الاسلاميه واجعلها بائعه الشاميه 😭🍃 اللهم عذب ام العربي وحولها الى بائعه البلبي اللهم عذب ام الجغرافيه واجعلها كلدجاجه الحافيه اللهم عذب ام التاريخ وزحلقها بقشره من البطيخ وارسلها الى المريخ اللهم عذب ام الاحياء واجعلها كل مومياء اللهم عذب المعاون اقتله بلمدرسه بهاون 😂😂😂"
